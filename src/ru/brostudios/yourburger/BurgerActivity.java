...
<<<<<<< HEAD
		restaurants[RestInfo.MCDONALDS].addBurger("Биг мак", "mcdonalds/bigmac.png", "Большой рубленый бифштекс из натуральной цельной говядины с двумя кусочками сыра «Чеддер» на карамелизованной булочке, заправленной горчицей, кетчупом, луком и двумя кусочками маринованного огурчика.", "");
		restaurants[RestInfo.MCDONALDS].addBurger("Биг тейсти", "mcdonalds/tasty.png", "Это сандвич с большим, рубленым бифштексом из 100% говядины на большой булочке с кунжутом. Особенный вкус сандвичу придают три кусочка сыра «эмменталь», два ломтика помидора, свежий салат, лук и пикантный соус «Гриль».", "");
		...
		restaurants[RestInfo.KFC].addBurger("Сандерс", "kfc/sanders.png", "Новый сандвич «Сандерс» - ярко, как никогда прежде, раскрывает знаменитый вкус, созданный самим полковником Сандерсом. Он приготовлен вручную из свежего куриного мяса по знаменитому секретному рецепту «11 трав и специй».   Нежное куриное филе с хрустящими маринованными огурчиками, сочным луком, заправленные кетчупом и майонезным соусом в мягкой кунжутной булочке …ммм…получилось SO GOOD!", "");
		restaurants[RestInfo.KFC].addBurger("Зингер", "kfc/zinger.png", "Хочешь острых ощущений? Сочное свежее куриное филе в обжигающе острой хрустящей панировке внутри булочки с кунжутом — взрывной вкус для самых дерзких!", "");
		...
		restaurants[RestInfo.BURGERKING].addBurger("Воппер", "burgerking/wopper.png", "Вкуснейшая приготовленная на огне 100% говядина с сочными помидорами, свежим нарезанным листовым салатом, густым майонезом, хрустящими маринованными огурчиками и рубленым белым луком на нежной булочке с кунжутной посыпкой.", "");
		restaurants[RestInfo.BURGERKING].addBurger("Стейкхаус", "burgerking/steik.png", "Сочетание нашей фирменной, приготовленной на огне 100% говядины с ломтиками бекона, а также специальным соусом «Барбекю», майонезом, сыром, листьями свежего салата, дольками помидоров и хрустящим луком на воздушной булочке, посыпанной кукурузной крошкой.", "");
		...
		restaurants[RestInfo.CARLSJR].addBurger("Гуакамоле", "carlsjr/guakamole.png", "Сочная котлета из говядины, булочка с кунжутом, лук, листья салата, помидор, швейцарский сыр, соус Санта Фе, соус Гуакамоле, поджаристый бекон.", "");
		restaurants[RestInfo.CARLSJR].addBurger("Биг марбл", "carlsjr/bigmurble.png", "Сочная котлета из мраморной говядины, булочка с кунжутом, лук, листья салата, помидор, американский сыр, горчица, майонез, кетчуп, маринованные огурчики.", "");
		...
		restaurants[RestInfo.SUBWAY].addBurger("Сабвей клаб", "subway/club.png", "Соблазнительное сочетание ростбифа, ветчины и индейки, свежие овощи по Вашему выбору на свежевыпеченном хлебе в комбинации с Вашим любимым соусом.", "");
		restaurants[RestInfo.SUBWAY].addBurger("Тунец", "subway/tunets.png", "Этот сэндвич просто подарок моря. Отжатый и перемешанный в правильной пропорции с майонезом тунец дает неповторимый вкус. Попробовав сэндвич с тунцом один раз, вы будете выбирать его снова и снова.", "");
=======
